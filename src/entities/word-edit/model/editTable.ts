...
/**
 * Короткая подпись таблицы — для чипов отбора на телефоне.
 *
 * Полные имена в шесть чипов занимали три ряда и съедали пол-экрана
 * до первой строки содержимого. Сокращения те же, что в списке слов,
 * так что читаются без обучения.
 */
export const EDIT_TABLE_SHORT: Record<EditTable, string> = {
  'Существительные': 'сущ.',
  'Глаголы': 'глаг.',
  'Наречия': 'нареч.',
  'Прилагательные': 'прил.',
  'Прилагательные и наречия': 'прил. · нареч.',
  'Служебные': 'служ.',
};
